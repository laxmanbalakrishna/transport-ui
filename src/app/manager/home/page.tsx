...
const HomePage = () => {
  ...
  const handleEdit = (installationId: number) => {
    router.push(`/manager/updateInstallation/${installationId}`);
  };
    ...
    <ManagerLayout>
      <main className="flex-1 bg-gray-100 p-8">
        ...
        <p className="mb-6 text-lg text-gray-700">
          This is your dashboard where you can update status for Insalled
          vehicle, view reports, and handle system settings.
        </p>
